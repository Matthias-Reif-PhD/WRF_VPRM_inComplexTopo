...
csv_file = f"./plots/Validation_FLUXNET_hourly_all{sim_type}_{timespan}.csv"  # <- put your CSV filename here
output_file = f"./plots/latex_table_{sim_type}_{timespan}.txt"
...
plt.tight_layout()
plt.savefig(
    f"./plots/site_comparison_1km{sim_type}.pdf",
    dpi=300,
)
plt.show()
